      ...
      <div class="shop_header">
        ...
        <div class="shop_text">
		  <router-link to="/classdetail">
			  ...
			  <span class="fn-c-memo-light">池之标 2021.03.23</span>
		  </router-link>
        </div>
		<div class="row fw-2" style="justify-content: flex-end;">
		  <mt-button class="fw-4" style="margin-right:10px;height:30px;width: 60px;" 
		  plain size="small" type="primary" @click ="signIn">签到</mt-button>
		</div>
      </div>
    </div>
  </section>
