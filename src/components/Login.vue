    ...
    <div class="loginInner">
      <div class="login_header">
        <div class="login_header_title">
          <a
            href="javascript:;"
            :class="{ on: loginForm.loginWay }"
            @click="loginForm.loginWay = true"
            >密码登录</a
          >
          <a
            href="javascript:;"
            :class="{ on: !loginForm.loginWay }"
            @click="loginForm.loginWay = false"
            >短信登录</a
          >
        </div>
      </div>
        ...
        <form>
          <div :class="{ on: loginForm.loginWay }" class="loginform">
            ...
            <section class="login_verification">
              ...
              <section
                class="switch_button"
                :class="loginForm.showPwd ? 'on' : 'off'"
                @click="loginForm.showPwd = !loginForm.showPwd"
              >
                <section
                  class="switch_circle"
                  :class="{ right: loginForm.showPwd }"
                ></section>
          ...
          <div :class="{ on: !loginForm.loginWay }" class="loginform">
            <section class="login_message">
              ...
              >
                {{
                  loginForm.computeTime > 0
                    ? `(${loginForm.computeTime}s)已发送`
                    : "获取验证码"
                }}
              </button>
            </section>
  ...
  methods: {
    ...
    async login() {
      ...
      if (!this.loginForm.loginWay) {
        ...
        if (
          !phonereg.test(this.loginForm.phone) ||
        ...
        if (
          this.loginForm.phone.length < 2 ||
          this.loginForm.phone.length > 8
        ) {
