        ...
        <form>
          ...
          <div>
            <section class="register_message">
              ...
              >
                {{
                  editForm.computeTime > 0
                    ? `(${editForm.computeTime}s)已发送`
                    : "获取验证码"
                }}
              </button>
            </section>
            ...
            <section class="register_verification">
              ...
              <section
                class="switch_button"
                :class="editForm.showPwd1 ? 'on' : 'off'"
                @click="editForm.showPwd1 = !editForm.showPwd1"
              >
                <section
                  class="switch_circle"
                  :class="{ right: editForm.showPwd1 }"
                ></section>
            ...
            <section class="register_verification">
              ...
              <section
                class="switch_button"
                :class="editForm.showPwd2 ? 'on' : 'off'"
                @click="editForm.showPwd2 = !editForm.showPwd2"
              >
                <section
                  class="switch_circle"
                  :class="{ right: editForm.showPwd2 }"
                ></section>
                <section class="switch_text">
                  {{ editForm.showPwd2 ? "" : "" }}
                </section>
            ...
            <section class="user_message">
              <mt-switch v-model="editForm.user"
                >如果是老师请点击左侧按钮</mt-switch
              >
            </section>
...
export default {
  ...
  methods: {
    ...
    async register() {
      if (
        this.editForm.phone.length == 0 ||
        this.editForm.code.length == 0 ||
        this.editForm.password1.length == 0 ||
        this.editForm.password2.length == 0
      ) {
      ...
      if (
        !phonereg.test(this.editForm.phone) ||
        this.editForm.phone.length != 11
      ) {
      ...
      //用户名和密码验证
      if (
        this.editForm.password1.length < 8 ||
        this.editForm.password1.length > 16
      ) {
